    ...
    public static Task[] getSampleTasks() {
        return new Task[] {
            new Task(new Name("CS2100 Assignment 3"), new TaskDescription("MSI, Sequential Circuit, Pipelining"),
                    new manageme.model.TagModule("CS2100"), TaskTime.empty(), new TaskTime("2021-11-08T13:00")),
            ...
            new Task(new Name("CS2100 Finals"), new TaskDescription("All topics, close book with cheatsheet"),
                    new manageme.model.TagModule("CS2100"), new TaskTime("2021-11-20T09:00"), new TaskTime("2021-11-20T11:00")),
            new Task(new Name("CS2105 Finals"), new TaskDescription("All topics, open book without internet"),
                    new manageme.model.TagModule("CS2105"), new TaskTime("2021-11-29T09:00"), new TaskTime("2021-11-29T11:00")),
            new Task(new Name("CS2103T Finals"), new TaskDescription("All topics, test UML drawing"),
                    new manageme.model.TagModule("CS2103T"), new TaskTime("2021-11-23T17:00"), new TaskTime("2021-11-23T19:00")),
            new Task(new Name("CS2103T PE"), new TaskDescription("Bug catching"),
                    new manageme.model.TagModule("CS2103T"), new TaskTime("2021-11-12T16:00"), new TaskTime("2021-11-12T18:00")),
            new Task(new Name("tP deadline"), new TaskDescription("Submit deliverables"),
                    new manageme.model.TagModule("CS2103T"), TaskTime.empty(), new TaskTime("2021-11-08T23:59")),
            new Task(new Name("CS2101 Reflection"), new TaskDescription("15% of overall grade"),
                    new manageme.model.TagModule("CS2101"), TaskTime.empty(), new TaskTime("2021-11-11T12:00")),
            new Task(new Name("Reading week"), new TaskDescription("Revision time"),
                    new manageme.model.TagModule(""), new TaskTime("2021-11-15T00:00"), new TaskTime("2021-11-19T23:59")),
    ...
    public static Link[] getSampleLinks() {
        return new Link[] {
            new Link(new Name("tP Github"),
                    new LinkAddress("https://github.com/AY2122S1-CS2103T-W11-3/tp"), new manageme.model.TagModule("CS2103T")),
