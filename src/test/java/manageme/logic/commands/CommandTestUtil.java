...
public class CommandTestUtil {
    ...
    public static final String MODNAME_DESC_CS2100 = " " + CliSyntax.PREFIX_NAME + VALID_MODNAME_CS2100;
    public static final String MODNAME_DESC_CS2103 = " " + CliSyntax.PREFIX_NAME + VALID_MODNAME_CS2103;
    public static final String LINK_DESC_ZOOM = " " + CliSyntax.PREFIX_LINK + VALID_LINK_ZOOM;
    public static final String LINK_DESC_GOOGLE = " " + CliSyntax.PREFIX_LINK + VALID_LINK_GOOGLE;
