...
public class ReadDayCommandParserTest {
    ...
    public void parse_validArgs_returnsReadDayCommand() {
        CommandParserTestUtil.assertParseSuccess(parser, LocalDate.now().toString(), new ReadDayCommand(LocalDate.now()));
    }

    @Test
    public void parse_invalidArgs_throwsParseException() {
        CommandParserTestUtil.assertParseFailure(parser, "a", String.format(Messages.MESSAGE_INVALID_COMMAND_FORMAT, ReadDayCommand.MESSAGE_USAGE));
    }
}
