...
1. Get the Markdown code for the Codecov badge provided in `Settings > Badges` and update the `docs/index.md` of your repo with it so that the badge [![codecov](https://codecov.io/gh/se-edu/ManageMe-level3/branch/master/graph/badge.svg)](https://codecov.io/gh/se-edu/ManageMe-level3) in that page reflects the coverage of your project.
...
1. Update the version number in [`MainApp.java`](https://github.com/se-edu/ManageMe-level3/tree/master/src/main/java/seedu/address/MainApp.java).
